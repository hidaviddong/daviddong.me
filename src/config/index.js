...
const SideProjects = [
  {
    name: "Lyrics Board",
    description: "Interactive lyrics display.",
    time: "2024",
    href: "/project/lyrics",
    background: "/images/david-tao-concert.jpg",
    keywords: ["David Tao", "lyrics", "concert", "light board"],
  },
  {
    name: "daviddong.me",
...
const Blog = [
  ...
  },
  {
    ...
    background:
      "/images/og/why-i-dont-use-note-taking-and-task-management-apps",
...
const Songs = [
  ...
  {
    title: "Once in a Blue Moon (feat. Mavis Fan)",
    artist: "YELLOW",
    url: "s34869641",
  },
