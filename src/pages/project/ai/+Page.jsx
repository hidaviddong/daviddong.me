		...
		<div className="flex flex-col">
			...
			<div className="flex flex-col space-y-12">
				...
				<div className="flex flex-col justify-center items-center">
					...
					<p className="my-0 text-zinc-400 text-sm">Different roles have different plugins.</p>
				</div>
				...
				<div className="flex flex-col justify-center items-center">
					...
					<p className="my-0 text-zinc-400 text-sm">Model can understand images.</p>
				</div>
				...
				<div className="flex flex-col justify-center items-center">
					...
					<p className="my-0 text-zinc-400 text-sm">Cite literature in conversations.</p>
				</div>
			</div>
		</div>
