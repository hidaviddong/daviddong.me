      ...
      <div className="flex flex-col space-y-12">
        ...
        <div className="flex flex-col justify-center items-center">
          <ReactCompareSlider
            ...
            itemTwo={
              <ReactCompareSliderImage
                src="/images/desktop-real-world.webp"
                alt="Desktop Real World"
              />
            }
            itemOne={
              <ReactCompareSliderImage
                src="/images/desktop-model.webp"
                alt="Desktop Model"
              />
            }
          />
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <p className="my-0 text-zinc-500 text-sm">
            Baking in Blender to generate textures and improve loading
            performance.
          </p>
        </div>
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <p className="my-0 text-zinc-500 text-sm">
            Implement map interaction using ECharts.
          </p>
        </div>
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <p className="my-0 text-zinc-500 text-sm">
            An EEG Analysis editor website.
          </p>
        </div>
      </div>
    </div>
