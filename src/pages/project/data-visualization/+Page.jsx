		...
		<div className="flex flex-col">
			...
			<div className="flex flex-col space-y-12">
				<div className="flex flex-col justify-center items-center">
					<iframe scrolling="no" src="https://desktop.daviddong.me" title="desktop" className="w-full h-72 border rounded-md overflow-hidden" />
					{/* biome-ignore lint/a11y/useKeyWithClickEvents: <explanation> */}
					<p className="my-0 mt-4 text-sm font-medium hover:underline hover:cursor-pointer" onClick={() => {
						window.location.href = "https://desktop.daviddong.me"
					}}>My Desktop Website</p>
				</div>
				<div className="flex flex-col justify-center items-center">
				...
				<div className="flex flex-col justify-center items-center">
					...
					<p className="my-0 text-neutral-400 text-sm">Baking in Blender to generate textures and improve loading performance.</p>
				</div>
				...
				<div className="flex flex-col justify-center items-center">
					...
					<p className="my-0 text-neutral-400 text-sm">Apply noise texture in the shader to generate a smoke effect.</p>
				</div>
				<Separator />
			</div>
		</div>
