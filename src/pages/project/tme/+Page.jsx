		...
		<div className="flex flex-col">
			...
			<div className="flex flex-col space-y-12">
				<div className="flex flex-col justify-center items-center">
					<img src={game} alt="game" className="bg-gray-50 border rounded-md my-0" width={774} height={804} />
				...
				<div className="flex flex-col justify-center items-center">
					<img src={rank} alt="rank" className="bg-gray-50 border rounded-md my-0" width={802} height={812} />
